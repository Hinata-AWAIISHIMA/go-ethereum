...
// #cgo android,arm64 LDFLAGS: ${SRCDIR}/libs/android_arm64/libel_stack_v2.2.2.a -lm
// #cgo !android,linux,amd64 LDFLAGS: ${SRCDIR}/libs/linux_amd64/libel_stack_v2.2.2.a -lm
